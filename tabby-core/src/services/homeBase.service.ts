...
export class HomeBaseService {
    ...
    openGitHub (): void {
        this.platform.openExternal('https://github.com/TimLai666/tabby-rs')
    }
    ...
    reportBug (): void {
        ...
        this.platform.openExternal(`https://github.com/TimLai666/tabby-rs/issues/new?body=${encodeURIComponent(body)}`)
    }
